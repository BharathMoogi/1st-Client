...
const BellIcon = () => (
  <Svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#80CBC4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const TagIcon = () => (
  <Svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#80CBC4" strokeWidth="2">
    ...
    <line x1="7" y1="7" x2="7.01" y2="7" stroke="#80CBC4" strokeWidth="2" />
  </Svg>
);
...
const HelpIcon = () => (
  <Svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#80CBC4" strokeWidth="2">
    ...
    <Line x1="12" y1="17" x2="12.01" y2="17" stroke="#80CBC4" strokeWidth="2" />
  </Svg>
);
      ...
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHeaderSection}>
          ...
          <View style={styles.avatarWrapper}>
            ...
            <LinearGradient colors={['#009688', '#00796B']} style={styles.avatar}>

    ...
    >
      <Defs>
        ...
        <LinearGradient id="goldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <Stop offset="0%" stopColor="#D89A7C" />
          <Stop offset="20%" stopColor="#A85D63" />
          <Stop offset="45%" stopColor="#8B4A50" />
          <Stop offset="60%" stopColor="#F5D061" />
          <Stop offset="80%" stopColor="#9B6B0E" />
          <Stop offset="100%" stopColor="#D89A7C" />
        </LinearGradient>
        ...
        <LinearGradient id="goldGradLight" x1="100%" y1="0%" x2="0%" y2="100%">
          ...
          <Stop offset="30%" stopColor="#D89A7C" />
          <Stop offset="70%" stopColor="#8B4A50" />
        ...
        <LinearGradient id="radialGlow" x1="50%" y1="50%" x2="100%" y2="50%">
          <Stop offset="0%" stopColor="#A85D63" stopOpacity={0.4} />
          <Stop offset="60%" stopColor="#8B4A50" stopOpacity={0.1} />
